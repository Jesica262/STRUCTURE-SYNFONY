...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('QAKZD-iVWz', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sqII-aE-2d', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('AxnryGunyW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xVdPffvdAD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zJED233+iM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cj3WiqKoD9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fIuaSf6Uie', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder60b82 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializerc1573 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties0e211 = [
        
    ];

    public function getConnection()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getConnection', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getMetadataFactory', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getExpressionBuilder', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'beginTransaction', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->beginTransaction();
    }

    public function getCache()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getCache', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getCache();
    }

    public function transactional($func)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'transactional', array('func' => $func), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->transactional($func);
    }

    public function commit()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'commit', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->commit();
    }

    public function rollback()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'rollback', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getClassMetadata', array('className' => $className), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'createQuery', array('dql' => $dql), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'createNamedQuery', array('name' => $name), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'createQueryBuilder', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'flush', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'clear', array('entityName' => $entityName), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->clear($entityName);
    }

    public function close()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'close', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->close();
    }

    public function persist($entity)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'persist', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'remove', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'refresh', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'detach', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'merge', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getRepository', array('entityName' => $entityName), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'contains', array('entity' => $entity), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getEventManager', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getConfiguration', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'isOpen', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getUnitOfWork', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getProxyFactory', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'initializeObject', array('obj' => $obj), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'getFilters', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'isFiltersStateClean', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'hasFilters', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return $this->valueHolder60b82->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializerc1573 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder60b82) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder60b82 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder60b82->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, '__get', ['name' => $name], $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        if (isset(self::$publicProperties0e211[$name])) {
            return $this->valueHolder60b82->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder60b82;
    ...
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, '__set', array('name' => $name, 'value' => $value), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;
    ...
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, '__isset', array('name' => $name), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;
    ...
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, '__unset', array('name' => $name), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;
    ...
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, '__clone', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        $this->valueHolder60b82 = clone $this->valueHolder60b82;
    }

    public function __sleep()
    {
        $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, '__sleep', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;

        return array('valueHolder60b82');
    }
    ...
    {
        $this->initializerc1573 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializerc1573;
    }

    public function initializeProxy() : bool
    {
        return $this->initializerc1573 && ($this->initializerc1573->__invoke($valueHolder60b82, $this, 'initializeProxy', array(), $this->initializerc1573) || 1) && $this->valueHolder60b82 = $valueHolder60b82;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder60b82;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder60b82;
    }
